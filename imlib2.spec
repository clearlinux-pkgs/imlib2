...
Version  : 1.11.0
Release  : 25
URL      : https://sourceforge.net/projects/enlightenment/files/imlib2-src/1.11.0/imlib2-1.11.0.tar.xz
Source0  : https://sourceforge.net/projects/enlightenment/files/imlib2-src/1.11.0/imlib2-1.11.0.tar.xz
...
%prep
%setup -q -n imlib2-1.11.0
cd %{_builddir}/imlib2-1.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678462357
