...
Version  : 1.12.3
Release  : 36
URL      : https://sourceforge.net/projects/enlightenment/files/imlib2-src/1.12.3/imlib2-1.12.3.tar.gz
Source0  : https://sourceforge.net/projects/enlightenment/files/imlib2-src/1.12.3/imlib2-1.12.3.tar.gz
...
%prep
%setup -q -n imlib2-1.12.3
cd %{_builddir}/imlib2-1.12.3
pushd ..
cp -a imlib2-1.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721056899
...
/V3/usr/lib64/libImlib2.so.1.12.3
