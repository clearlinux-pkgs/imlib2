...
Version  : 1.7.2
Release  : 16
URL      : https://sourceforge.net/projects/enlightenment/files/imlib2-src/1.7.2/imlib2-1.7.2.tar.gz
Source0  : https://sourceforge.net/projects/enlightenment/files/imlib2-src/1.7.2/imlib2-1.7.2.tar.gz
...
%prep
%setup -q -n imlib2-1.7.2
cd %{_builddir}/imlib2-1.7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627491584
...
cp %{_builddir}/imlib2-1.7.2/COPYING %{buildroot}/usr/share/package-licenses/imlib2/4bb00a078e16718ff6547e7ec70b558a8dd3680a
%make_install
