...
Version  : 1.12.5
Release  : 38
URL      : https://sourceforge.net/projects/enlightenment/files/imlib2-src/1.12.5/imlib2-1.12.5.tar.gz
Source0  : https://sourceforge.net/projects/enlightenment/files/imlib2-src/1.12.5/imlib2-1.12.5.tar.gz
...
%prep
%setup -q -n imlib2-1.12.5
cd %{_builddir}/imlib2-1.12.5
pushd ..
cp -a imlib2-1.12.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744038373
...
/V3/usr/lib64/libImlib2.so.1.12.5
