...
Version  : 1.12.4
Release  : 37
URL      : https://sourceforge.net/projects/enlightenment/files/imlib2-src/1.12.4/imlib2-1.12.4.tar.gz
Source0  : https://sourceforge.net/projects/enlightenment/files/imlib2-src/1.12.4/imlib2-1.12.4.tar.gz
...
%prep
%setup -q -n imlib2-1.12.4
cd %{_builddir}/imlib2-1.12.4
pushd ..
cp -a imlib2-1.12.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742415604
...
/V3/usr/lib64/libImlib2.so.1.12.4
