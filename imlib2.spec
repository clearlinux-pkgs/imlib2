...
Version  : 1.9.0
Release  : 22
URL      : https://sourceforge.net/projects/enlightenment/files/imlib2-src/1.9.0/imlib2-1.9.0.tar.xz
Source0  : https://sourceforge.net/projects/enlightenment/files/imlib2-src/1.9.0/imlib2-1.9.0.tar.xz
...
%prep
%setup -q -n imlib2-1.9.0
cd %{_builddir}/imlib2-1.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650735973
...
cp %{_builddir}/imlib2-1.9.0/COPYING %{buildroot}/usr/share/package-licenses/imlib2/4bb00a078e16718ff6547e7ec70b558a8dd3680a
%make_install
