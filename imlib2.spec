...
Source0  : https://sourceforge.net/projects/enlightenment/files/imlib2-src/1.7.3/imlib2-1.7.3.tar.gz
...
%prep
%setup -q -n imlib2-1.7.3
cd %{_builddir}/imlib2-1.7.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628782075
...
cp %{_builddir}/imlib2-1.7.3/COPYING %{buildroot}/usr/share/package-licenses/imlib2/4bb00a078e16718ff6547e7ec70b558a8dd3680a
%make_install
